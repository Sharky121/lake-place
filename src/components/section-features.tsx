            ...
            <div className="page-section__container container">
                ...
                <ul className="features__list">
                    ...
                    <li className="features__item">
                        ...
                        <p>Уникальный климат: большое количество водоемов (цепь Великих мещерских озер) и девственные леса. <br/> Неслучайно Мещеру называют Русской Амазонкой. <br/>Практически вся территория Мещеры находится в зоне Мешерского национального парка</p>
                    </li>
                    <li className="features__item">
                        <svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <p>Наличие удобной инфраструктуры: газ, электричество, дороги</p>
                    </li>
                </ul>
            </div>
        </section>
